# AWS · 物模型与数字孪生：从设备影子到 TwinMaker，孪生不止存状态
...
## 1.问题背景：从设备影子到TwinMaker——孪生不只是存状态
...
![AWS IoT 设备影子与数字孪生（官方原图）](/images/series/iot-platform-design/aws/aws-what-is-official.png)
